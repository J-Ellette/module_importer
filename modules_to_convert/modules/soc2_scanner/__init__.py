"""
Soc2 Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import SOC2Scanner
from common.report_generator import ReportGenerator


class SOC2ScannerModule(ModuleBase):
    """
    ModuleBase wrapper for SOC2Scanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Soc2 Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = SOC2Scanner(target_path)
