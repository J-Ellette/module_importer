"""
Case Tools Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CaseToolsScanner
from common.report_generator import ReportGenerator


class CaseToolsScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CaseToolsScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "case_tools_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Case Tools Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CaseToolsScanner(target_path)
...
__all__ = ['CaseToolsScannerModule']
