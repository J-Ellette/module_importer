"""
Security Scanner Module - Adapted for ModuleBase interface.
"""
...
class SecurityScannerModule(ModuleBase):
    """
    ModuleBase wrapper for SecurityScanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Security Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = SecurityScanner(target_path)
