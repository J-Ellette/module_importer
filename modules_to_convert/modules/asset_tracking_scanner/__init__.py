"""
Asset Tracking Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import AssetTrackingScanner
from common.report_generator import ReportGenerator


class AssetTrackingScannerModule(ModuleBase):
    """
    ModuleBase wrapper for AssetTrackingScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "asset_tracking_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Asset Tracking Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = AssetTrackingScanner(target_path)
...
__all__ = ['AssetTrackingScannerModule']
