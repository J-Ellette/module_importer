"""
Quality Management Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import QualityManagementScanner
from common.report_generator import ReportGenerator


class QualityManagementScannerModule(ModuleBase):
    """
    ModuleBase wrapper for QualityManagementScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "quality_management_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Quality Management Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = QualityManagementScanner(target_path)
...
__all__ = ['QualityManagementScannerModule']
