"""
Sbom Scanner Module - Adapted for ModuleBase interface.
"""
...
class SBOMScannerModule(ModuleBase):
    """
    ModuleBase wrapper for SBOMScanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Sbom Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = SBOMScanner(target_path)
