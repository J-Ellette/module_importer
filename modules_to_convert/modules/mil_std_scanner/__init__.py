"""
Mil Std Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import MilStdScanner
from common.report_generator import ReportGenerator


class MilStdScannerModule(ModuleBase):
    """
    ModuleBase wrapper for MilStdScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "mil_std_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Mil Std Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = MilStdScanner(target_path)
