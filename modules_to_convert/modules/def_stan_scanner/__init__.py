"""
Def Stan Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import DefStanScanner
from common.report_generator import ReportGenerator


class DefStanScannerModule(ModuleBase):
    """
    ModuleBase wrapper for DefStanScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "def_stan_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Def Stan Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = DefStanScanner(target_path)
