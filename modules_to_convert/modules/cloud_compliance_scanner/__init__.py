"""
Cloud Compliance Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CloudComplianceScanner
from common.report_generator import ReportGenerator


class CloudComplianceScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CloudComplianceScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "cloud_compliance_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Cloud Compliance Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CloudComplianceScanner(target_path)
...
__all__ = ['CloudComplianceScannerModule']
