"""
Dynamics Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import DynamicsScanner
from common.report_generator import ReportGenerator


class DynamicsScannerModule(ModuleBase):
    """
    ModuleBase wrapper for DynamicsScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "dynamics_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Dynamics Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = DynamicsScanner(target_path)
