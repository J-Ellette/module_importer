"""
Hacms Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import HACMSScanner
from common.report_generator import ReportGenerator


class HACMSScannerModule(ModuleBase):
    """
    ModuleBase wrapper for HACMSScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "hacms_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Hacms Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = HACMSScanner(target_path)
