"""
Safedocs Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import SafeDocsScanner
from common.report_generator import ReportGenerator


class SafeDocsScannerModule(ModuleBase):
    """
    ModuleBase wrapper for SafeDocsScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "safedocs_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Safedocs Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = SafeDocsScanner(target_path)
