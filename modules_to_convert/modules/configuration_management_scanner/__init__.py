"""
Configuration Management Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import ConfigurationManagementScanner
from common.report_generator import ReportGenerator


class ConfigurationManagementScannerModule(ModuleBase):
    """
    ModuleBase wrapper for ConfigurationManagementScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "configuration_management_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Configuration Management Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = ConfigurationManagementScanner(target_path)
...
__all__ = ['ConfigurationManagementScannerModule']
