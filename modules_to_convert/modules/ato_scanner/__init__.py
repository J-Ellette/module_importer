"""
Ato Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import ATOScanner
from common.report_generator import ReportGenerator


class ATOScannerModule(ModuleBase):
    """
    ModuleBase wrapper for ATOScanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Ato Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = ATOScanner(target_path)
