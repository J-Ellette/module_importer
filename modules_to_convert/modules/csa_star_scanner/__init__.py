"""
Csa Star Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CSAStarScanner
from common.report_generator import ReportGenerator


class CSAStarScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CSAStarScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "csa_star_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Csa Star Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CSAStarScanner(target_path)
