"""
Iso27001 Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import ISO27001Scanner
from common.report_generator import ReportGenerator


class ISO27001ScannerModule(ModuleBase):
    """
    ModuleBase wrapper for ISO27001Scanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "iso27001_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Iso27001 Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = ISO27001Scanner(target_path)
