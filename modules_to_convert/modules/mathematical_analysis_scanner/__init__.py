"""
Mathematical Analysis Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import MathematicalAnalysisScanner
from common.report_generator import ReportGenerator


class MathematicalAnalysisScannerModule(ModuleBase):
    """
    ModuleBase wrapper for MathematicalAnalysisScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "mathematical_analysis_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Mathematical Analysis Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = MathematicalAnalysisScanner(target_path)
...
__all__ = ['MathematicalAnalysisScannerModule']
