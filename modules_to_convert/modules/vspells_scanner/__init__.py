"""
Vspells Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import VSpellsScanner
from common.report_generator import ReportGenerator


class VSpellsScannerModule(ModuleBase):
    """
    ModuleBase wrapper for VSpellsScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "vspells_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Vspells Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = VSpellsScanner(target_path)
