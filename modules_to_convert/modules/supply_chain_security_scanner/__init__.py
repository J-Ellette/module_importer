"""
Supply Chain Security Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import SupplyChainSecurityScanner
from common.report_generator import ReportGenerator


class SupplyChainSecurityScannerModule(ModuleBase):
    """
    ModuleBase wrapper for SupplyChainSecurityScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "supply_chain_security_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Supply Chain Security Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = SupplyChainSecurityScanner(target_path)
...
__all__ = ['SupplyChainSecurityScannerModule']
