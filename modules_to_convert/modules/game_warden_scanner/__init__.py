"""
Game Warden Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import GameWardenScanner
from common.report_generator import ReportGenerator


class GameWardenScannerModule(ModuleBase):
    """
    ModuleBase wrapper for GameWardenScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "game_warden_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Game Warden Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = GameWardenScanner(target_path)
...
__all__ = ['GameWardenScannerModule']
