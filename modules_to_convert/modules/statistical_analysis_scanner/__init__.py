"""
Statistical Analysis Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import StatisticalAnalysisScanner
from common.report_generator import ReportGenerator


class StatisticalAnalysisScannerModule(ModuleBase):
    """
    ModuleBase wrapper for StatisticalAnalysisScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "statistical_analysis_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Statistical Analysis Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = StatisticalAnalysisScanner(target_path)
...
__all__ = ['StatisticalAnalysisScannerModule']
