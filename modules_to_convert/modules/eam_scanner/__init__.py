"""
Eam Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import EAMScanner
from common.report_generator import ReportGenerator


class EAMScannerModule(ModuleBase):
    """
    ModuleBase wrapper for EAMScanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Eam Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = EAMScanner(target_path)
