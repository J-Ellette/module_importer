"""
Armature Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import ArmatureScanner
from common.report_generator import ReportGenerator


class ArmatureScannerModule(ModuleBase):
    """
    ModuleBase wrapper for ArmatureScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "armature_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Armature Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = ArmatureScanner(target_path)
