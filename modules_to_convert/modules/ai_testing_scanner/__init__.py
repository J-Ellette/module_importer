"""
Ai Testing Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import AITestingScanner
from common.report_generator import ReportGenerator


class AITestingScannerModule(ModuleBase):
    """
    ModuleBase wrapper for AITestingScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "ai_testing_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Ai Testing Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = AITestingScanner(target_path)
...
__all__ = ['AITestingScannerModule']
