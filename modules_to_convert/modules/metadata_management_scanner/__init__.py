"""
Metadata Management Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import MetadataManagementScanner
from common.report_generator import ReportGenerator


class MetadataManagementScannerModule(ModuleBase):
    """
    ModuleBase wrapper for MetadataManagementScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "metadata_management_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Metadata Management Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = MetadataManagementScanner(target_path)
...
__all__ = ['MetadataManagementScannerModule']
