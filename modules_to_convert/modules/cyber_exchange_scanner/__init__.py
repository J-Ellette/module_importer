"""
Cyber Exchange Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CyberExchangeScanner
from common.report_generator import ReportGenerator


class CyberExchangeScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CyberExchangeScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "cyber_exchange_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Cyber Exchange Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CyberExchangeScanner(target_path)
...
__all__ = ['CyberExchangeScannerModule']
