"""
Personnel Security Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import PersonnelSecurityScanner
from common.report_generator import ReportGenerator


class PersonnelSecurityScannerModule(ModuleBase):
    """
    ModuleBase wrapper for PersonnelSecurityScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "personnel_security_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Personnel Security Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = PersonnelSecurityScanner(target_path)
...
__all__ = ['PersonnelSecurityScannerModule']
