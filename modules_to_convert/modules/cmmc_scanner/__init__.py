"""
Cmmc Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CMMCScanner
from common.report_generator import ReportGenerator


class CMMCScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CMMCScanner.
    """
    ...
    def get_description(self) -> str:
        ...
        return "Cmmc Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CMMCScanner(target_path)
