"""
Digital Government Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import DigitalGovernmentScanner
from common.report_generator import ReportGenerator


class DigitalGovernmentScannerModule(ModuleBase):
    """
    ModuleBase wrapper for DigitalGovernmentScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "digital_government_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Digital Government Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = DigitalGovernmentScanner(target_path)
...
__all__ = ['DigitalGovernmentScannerModule']
