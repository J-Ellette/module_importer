"""
Fedramp Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import FedRAMPScanner
from common.report_generator import ReportGenerator


class FedRAMPScannerModule(ModuleBase):
    """
    ModuleBase wrapper for FedRAMPScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "fedramp_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Fedramp Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = FedRAMPScanner(target_path)
