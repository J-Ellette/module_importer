"""
Regscale Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import RegScaleScanner
from common.report_generator import ReportGenerator


class RegScaleScannerModule(ModuleBase):
    """
    ModuleBase wrapper for RegScaleScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "regscale_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Regscale Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = RegScaleScanner(target_path)
