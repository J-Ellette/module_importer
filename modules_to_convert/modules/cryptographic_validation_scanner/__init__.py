"""
Cryptographic Validation Scanner Module - Adapted for ModuleBase interface.
"""
...
from .scanner import CryptographicValidationScanner
from common.report_generator import ReportGenerator


class CryptographicValidationScannerModule(ModuleBase):
    """
    ModuleBase wrapper for CryptographicValidationScanner.
    """
    
    def get_name(self) -> str:
        """Return the module name."""
        return "cryptographic_validation_scanner"
    ...
    def get_description(self) -> str:
        ...
        return "Cryptographic Validation Scanner - Code scanning and analysis module"
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.scanner = CryptographicValidationScanner(target_path)
...
__all__ = ['CryptographicValidationScannerModule']
